  ...
  await knex("games").insert([
    {
      ...
      rating: 5,
      summary:
        "Link wakes up after a century of slumber to defeat Calamity Ganon and save Hyrule in this sprawling open-world adventure.",
      coverArt:
    ...
    },
    {
      ...
      rating: 4,
      summary:
        "Build and customize your own island paradise in this delightful life simulation game.",
      coverArt:
    ...
    },
    {
      ...
      rating: 2,
      summary:
        "Explore a dark fantasy world filled with dangerous enemies, intense combat, and mysterious lore.",
      coverArt:
